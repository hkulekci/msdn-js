---
title: getFloat32 Method (DataView)
isChild: false
---

## getFloat32 Method (DataView) {getfloat32_method_dataview_title}
...
= req.response; var dataView = new DataView(buffer); alert(dataView.getFloat32(0)); } }
```
