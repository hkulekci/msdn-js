---
title: getUint32 Method (DataView)
isChild: false
---

## getUint32 Method (DataView) {getuint32_method_dataview_title}
...
= req.response; var dataView = new DataView(buffer); alert(dataView.getUint32(0)); } }
```
