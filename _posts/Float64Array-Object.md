...
<div id="sectionSection0" class="section" name="collapseableSection" style="" expanded="true">
  <dl class="authored">
    <dt>
      <span class="parameter" sdata="paramReference" xmlns:util="util">float64Array</span>
    </dt>
    <dd>
      <p xmlns:util="util">
        Required. The variable name to which the <b>Float64Array</b> object is assigned.
      </p>
    </dd>
    <dt>
...
<div id="sectionSection1" class="section" name="collapseableSection" style="" expanded="true">
  <p xmlns:util="util">
    The following table lists the constants of the <b>Float64Array</b>object.
  </p>
...
<div id="sectionSection3" class="section" name="collapseableSection" style="" expanded="true">
  <p xmlns:util="util">
    The following table lists the methods of the <b>Float64Array</b>object.
  </p>
  <div class="caption"></div>
  <div class="tableSection">
    <table width="50%" cellspacing="2" cellpadding="5" frame="lhs">
      ...
      <tr>
        <td>
          <p xmlns:util="util">
            <span sdata="link"><a href="694965e6-503d-4aaa-8340-63455e96ddf6.htm">set Method (Float64Array)</a></span>
          </p>
        </td>
        <td>
          <p xmlns:util="util">
...
= req.response; var dataview = new DataView(buffer); var ints = new Float64Array(buffer.byteLength / 8); for (var i = 0; i &lt; ints.length; i++) { ints[i] = dataview.getFloat64(i * 8); }
alert(ints[10]); } }
```
