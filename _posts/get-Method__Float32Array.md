---
title: get Method (Float32Array)
isChild: false
---

## get Method (Float32Array) {get_method_float32array_title}
...
= req.response; var dataView = new DataView(buffer); var floatArr = new Float32Array(buffer.byteLength / 4); var element = floatArr.get(0); } }
```
