---
title: getInt16 Method (DataView)
isChild: false
---

## getInt16 Method (DataView) {getint16_method_dataview_title}
...
= req.response; var dataView = new DataView(buffer); alert(dataView.getInt16(0)); } }
```
