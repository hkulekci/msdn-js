---
title: getUint16 Method (DataView)
isChild: false
---

## getUint16 Method (DataView) {getuint16_method_dataview_title}
...
= req.response; var dataView = new DataView(buffer); alert(dataView.getUint16(0)); } }
```
