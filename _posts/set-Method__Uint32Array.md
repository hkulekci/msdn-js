---
title: set Method (Uint32Array)
isChild: false
---

## set Method (Uint32Array) {set_method_uint32array_title}
...
= req.response; var dataView = new DataView(buffer); var intArr = new Uint32Array(buffer.byteLength / 4); intArr.set(0, 9); } }
```
