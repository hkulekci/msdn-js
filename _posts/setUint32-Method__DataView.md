---
title: setUint32 Method (DataView)
isChild: false
---

## setUint32 Method (DataView) {setuint32_method_dataview_title}
...
= req.response; var dataView = new DataView(buffer); dataView.setUint32(0, 9); } }
```
