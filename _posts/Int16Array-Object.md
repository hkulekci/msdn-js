---
title: Int16Array Object
isChild: false
---

## Int16Array Object {int16array_object_title}
...
<div id="sectionSection0" class="section" name="collapseableSection" style="" expanded="true">
  <dl class="authored">
    <dt>
      <span class="parameter" sdata="paramReference" xmlns:util="util">int16Array</span>
    </dt>
    <dd>
      <p xmlns:util="util">
        Required. The variable name to which the <b>Int16Array</b> object is assigned.
      </p>
    </dd>
    <dt>
...
<div id="sectionSection1" class="section" name="collapseableSection" style="" expanded="true">
  <p xmlns:util="util">
    The following table lists the constants of the <b>Int16Array</b>object.
  </p>
...
<div id="sectionSection3" class="section" name="collapseableSection" style="" expanded="true">
  <p xmlns:util="util">
    The following table lists the methods of the <b>Int16Array</b>object.
  </p>
  <div class="caption"></div>
  <div class="tableSection">
    <table width="50%" cellspacing="2" cellpadding="5" frame="lhs">
      ...
      <tr>
        <td>
          <p xmlns:util="util">
            <span sdata="link"><a href="e35adfff-7052-4ef9-80be-3abbf8230e88.htm">set Method (Int16Array)</a></span>
          </p>
        </td>
        <td>
          <p xmlns:util="util">
      ...
      <tr>
        <td>
          <p xmlns:util="util">
            <span sdata="link"><a href="8a7437c2-8c4e-41eb-a3d5-ec4f7399b81d.htm">subarray Method (Int16Array)</a></span>
          </p>
        </td>
        <td>
          <p xmlns:util="util">
...
= req.response; var dataview = new DataView(buffer); var ints = new Int16Array(buffer.byteLength / 2); for (var i = 0; i &lt; ints.length; i++) { ints[i] = dataview.getInt16(i * 2); }
alert(ints[10]); } }
```
